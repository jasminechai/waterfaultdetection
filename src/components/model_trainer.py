...
class ModelTrainer:
    ...
    def get_best_model(self,
        ...
        try:
            ...
            best_model_object = self.models[best_model_score]
    ...
    def initiate_model_training(self, train_array, test_array):
        try:
            ...
            best_model_name = list(model_report.values()).index(best_model_score)
            ...
            # check the accuracy score threshold
            ...
            self.utils.save_object(
                file_path=ModelTrainerConfig.trained_model_path,
                obj=best_model
            )
