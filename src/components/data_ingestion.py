...
from zipfile import Path # unzipping files
...
Class DataIngestionConfig:
    # storing path so other functions can access it
...
class DataIngestion:
    ...
    def export_data_into_feature_store_file_path(self) -> pd.DataFrame:
        ...
        try:
            ...
            logging.info(f"saving exported data into feature store file path: (raw_file)")
    ...
    def initiate_data_ingestion(self) -> Path:
        ...
        Output     : train set and test set are returned as the artifacts of data ingestion compenents
        On Failure : Write an exception log and then raise an exception
